        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
          <div className="md:w-1/2">
            ...
            <p>
              ...
              <span className="font-bold">driven</span> product owner and business leader with expertise
              across E-commerce, crypto and supply chain. My goal is to build products that redefine the
              way we create value and engage with commerce in Nigeria.
            </p>
            <br />
            <p>
              I graduated from the University of Sheffield, United Kingdom in 2019 with a BEng in
              Electronic and Communications Engineering. I have since taken academic interest in
              Blockchain and the EVM while building a career in solving problems, developing products
